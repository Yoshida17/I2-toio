...
1. [位置情報の基礎](day2/mat.html) - マットを使った座標・角度の取得
2. [位置制御](day2/mat-control.html) - 目標座標への移動と回転
3. [キーボード操作](day2/keyboard-control.html) - 実時間制御
4. [コンテスト課題](day2/challenge-guide.html) - 宝探しゲーム
